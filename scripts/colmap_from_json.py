...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_folder", type=str, default='./', help="Project input dir.")
    ...
    with open(os.path.join(args.input_folder,'camera.json'), 'r') as json_file:
    ...
    for image_info in data:
        i = np.array([
            [image_info["fx"], 0.0, image_info["cx"]],
            [0.0, image_info["fy"], image_info["cy"]],
            [0.0, 0.0, 1.0]
        ])
        intrinsic[image_info['id']] = i
        e = np.zeros((4, 4))
        e[0,0], e[0,1], e[0,2], e[0,3] = image_info["R"][0][0], image_info["R"][1][0], image_info["R"][2][0], image_info["T"][0]
        e[1,0], e[1,1], e[1,2], e[1,3] = image_info["R"][0][1], image_info["R"][1][1], image_info["R"][2][1], image_info["T"][1]
        e[2,0], e[2,1], e[2,2], e[2,3] = image_info["R"][0][2], image_info["R"][1][2], image_info["R"][2][2], image_info["T"][2]
        e[3,0], e[3,1], e[3,2], e[3,3] = 0.0, 0.0, 0.0, 1.0
        extrinsic.append(e)
